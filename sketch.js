...
if(gameState===SIXTH){
  ...
  text (" lets give the body and the ",850,250)
  text ("finger print for examination.",850,300)
  text ("From the name bar we get to know that",850,350)
  text ("the name of the thief is 'MONDE' ",850,400)
